  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        ...
        case "fetchFaceById": {
          service.fetchFaceById(json.getValue("id") == null ? null : (json.getLong("id").intValue()),
                        HelperUtils.createHandler(msg));
          break;
        }
        case "createFace": {
          service.createFace(json.getValue("id") == null ? null : (json.getLong("id").intValue()),
                        (java.lang.String)json.getValue("remote"),
                        (java.lang.String)json.getValue("local"),
                        HelperUtils.createHandler(msg));
          break;
        }
        case "saveFace": {
          service.saveFace(json.getValue("id") == null ? null : (json.getLong("id").intValue()),
                        (java.lang.String)json.getValue("remote"),
                        (java.lang.String)json.getValue("local"),
                        HelperUtils.createHandler(msg));
          break;
        ...
        case "deleteFace": {
          service.deleteFace(json.getValue("id") == null ? null : (json.getLong("id").intValue()),
                        HelperUtils.createHandler(msg));
          break;
        }
        case "deleteAllFaces": {
